...
def create_igp_routing_instances():
    ...
    igp_isis_r3, _ = IGPRoutingInstance.objects.get_or_create(
        name="ISIS-router3",
        device=devices["router3"],
        protocol="ISIS",
        defaults={
            "description": "ISIS routing instance for router3",
...
def create_isis_configurations():
    ...
    isis_config_r3, _ = ISISConfiguration.objects.get_or_create(
        name="ISIS-Config-R3",
        instance=igp_instances["isis_router3"],
        defaults={
            "status": statuses["active"],
            # system_id will be auto-generated by model save()
        },
...
def create_isis_interface_configurations():
    ...
    # ISIS on router3 GigabitEthernet1
    isis_int_r3_ge1, _ = ISISInterfaceConfiguration.objects.get_or_create(
        name="ISIS-R3-GE1",
        isis_config=isis_configs["router3"],
        device=devices["router3"],
